...
def users_group():
    """
    Group of commands for managing users.
    """
    pass

@users_group.command('create-admin', help='Create a new administrator user.')
...
@users_group.command('delete-user', help='Delete an existing user by username.')
